...
public class ProfesseursDAO {
	 ...
	 *             SQL Exception in case it didn't work properly
	 */
	public void insertProfesseur(Professeurs professeur_new) throws SQLException {
	 ...
	 *             SQL Exception in case it didn't work properly
	 */
	public void updateProfesseur(Professeurs professeur_modifie) throws SQLException {
